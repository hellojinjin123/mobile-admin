		...
		<tr>
			<th width="600">
				<div class="qw-fl grid-add-data">
					<input type="button" value="添加广告" onclick="goToUrl('__APP__/Admin/Advert/edit/mid/<?php echo ($_GET['mid']); ?>/cid/<?php echo ($cid); ?>');" class="button-img-add" />
				</div>
...
<table class="grid-table" border="1" cellpadding="0" cellspacing="0"> 
	...
	<tbody>
		<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr> 
		    ...
		    <td><a href="__APP__/Admin/<?php echo ($actionName); ?>/edit/id/<?php echo ($vo["id"]); ?>/mid/<?php echo ($_GET['mid']); ?>/cid/<?php echo ($vo["category_id"]); ?>"><?php echo ($vo["title"]); ?></a>
		    ...
		    <td><?php echo ($vo["width"]); ?>X<?php echo ($vo["height"]); ?></td>
		    ...
		    <td><a href="__APP__/Admin/<?php echo ($actionName); ?>/edit/id/<?php echo ($vo["id"]); ?>/mid/<?php echo ($_GET['mid']); ?>/cid/<?php echo ($vo["category_id"]); ?>"><img src="__ADMIN__/Public/imgs/edit.png" />编辑</a>&nbsp;&nbsp;&nbsp;
		    <a href="#" onclick="javascript:deleteData('__APP__/Admin/<?php echo ($actionName); ?>/deleteById/mid/<?php echo ($_GET['mid']); ?>/id/<?php echo ($vo["id"]); ?>');"><img src="__ADMIN__/Public/imgs/cross.png" />删除</a></td>
