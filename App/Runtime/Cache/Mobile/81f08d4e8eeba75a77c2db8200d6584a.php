...
<title><?php echo ($obj["title"]); ?>_资讯详情</title>
<!-- layout::Inc:top::0 -->
</head>
...
<div data-role="header" id="tit">
	<a href="__APP__/Mobile/News/view/cid/<?php echo ($_GET['cid']); ?>" data-icon="back" class="tit_btn" rel="external">返回</a>
	<h1>资讯详情</h1>
...
<div data-role="content" style="background:#fff; border:none;" >
  <div class="pro_data">
    ...
    <?php if($obj["image"] != '' ): ?><div><img src="__UPLOAD__/images/news/m_<?php echo ($obj["image"]); ?>" width="100%" height="100%"></div><?php endif; ?>
